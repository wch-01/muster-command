...
@Component({ selector: "app-system-admin-page", standalone: true, imports: [CommonModule, IonContent, AppMenuComponent, SiteFooterComponent], templateUrl: "./system-admin.page.html", styleUrls: ["./system-admin.page.scss"] })
